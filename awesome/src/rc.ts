...
import { Client } from "awesomewm.4.3.ts.d/awesomewm/awful/client";
...
const globalKeys = table.join<awful.Key<Screen>>(
  ...
  awful.key(
    ...
    "Left",
    () =>
      awful.screen.focus_bydirection(
        Direction.Left,
        awful.screen.focused() as Screen
      ),
    {
